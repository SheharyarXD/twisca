...
const ProductPageProducts=(
    ...
    return(
        <div className="max-h-[360px] w-[250px] rounded-[1vw] p-1 my-5" onClick={() => Redirect(productid, setproductDetailId,navigate,fetchProductById)}>
            ...
            <div className="text-white bg-[#414141]  w-fit px-2.5 py-1 absolute top-2 left-2 text-xs rounded-lg">{discount}{(100-(((originalPrice)/currentPrice)*100)).toFixed(2)}%</div>
