...
const LovedPorducts=({product })=>{
    ...
    return(
        <div className="max-h-fit bg-[#FFE8FF] w-[250px] rounded-[1vw] p-3" onClick={()=>navigate(`/products/productDetails/${product.productid}`)}>
            ...
            <img src="./Images/ri-star-fill.png" className="pr-1" alt="" /> <p><span className="pr-3">{product.avg_rating}</span>|<span className="pl-3">{product.total_reviews}</span> sold</p>
            </div>
